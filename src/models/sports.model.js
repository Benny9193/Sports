/**
 * Sports Data Model
 * Contains all sports data organized by category
 */
...
function getSportsByCategory(category) {
    return sportsData[category] || null;
}
...
function searchSports(query) {
    ...
    Object.entries(sportsData).forEach(([categoryKey, category]) => {
